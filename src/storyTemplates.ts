...
const AI_THEMES = [
  ...
  },
  {
    id: 'give-card',
    title: '把银行卡交给信任的人',
    body: '靠意志力硬扛很累，也不稳。给冲动设一道物理障碍会更有效。今天可以做一件实在的事：把银行卡、信用卡或大部分现金交给家人保管，让“想赌也拿不到钱”替你挡住最冲动的那一刻。',
  },
  {
    id: 'delete-app',
    title: '先删掉赌博 App',
...
const WALL_SEED_STORIES: { gamblingType: GamblingType; title: string; body: string }[] = [
  ...
  { gamblingType: 'casino', title: '我把银行卡交给了老婆', body: '靠意志力我扛不住，我承认。于是我把银行卡、信用卡都交给她保管，身上只带一点现金。想赌也拿不到钱——这不是没面子，是我给自己修的一道墙。' },
  ...
  { gamblingType: 'lottery', title: '路过便利店，我没买', body: '每天下班都路过那家便利店，以前总要顺手来两张刮刮乐。今天我看了一眼 App 里的省钱数字，走了过去，没买。就这一次"没买"，让我相信下一次我也能。' },
